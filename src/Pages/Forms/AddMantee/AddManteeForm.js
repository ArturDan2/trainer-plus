...
const AddManteeForm = () => {
  ...
  function NewMantee(fname,lname,gender,email,phonenumber,weight,height,goal,birthday){
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    const newMantee = new NewMantee(fname,lname,gender,email,phonenumber,weight,height,goal,birthday);
    try {
      const docRef = await addDoc(collection(db, "mantees"), Object.assign({}, newMantee));
  ...
  return (
    <div className="add-mantee grid-container">
      <form className="add-mantee form" onSubmit={onSubmitHandler}>
        <section>
