...
const CircumferencesTable = ({circumferencesData, setMantee, affilation}) => {
  ...
  return (
    <div className={`circumferences-table ${affilation}`}>
        <div className="heading">
          <h4>OBWODY CIAŁA</h4>
          <ExpendableButton windowInsides={<UpdateCircumferencesWindow circumferencesData={circumferencesData} setMantee={setMantee} />}/>
        </div>
